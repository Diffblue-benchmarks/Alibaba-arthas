...
public class StringUtilsTest {
    ...
    public void testNormalizeClassName() {
        ...
        Assert.assertEquals(",.o\'+$g--.", StringUtils.normalizeClassName(",.o\'+$g--."));
        Assert.assertEquals("", StringUtils.normalizeClassName(""));
    }
    ...
    public void testSplitArrayElementsIntoProperties() {
        ...
        final String[] array2 = {"1=foo", "2=bar"};
        final Properties prop = new Properties();
        prop.setProperty("1", "foo");
        prop.setProperty("2", "bar");
        Assert.assertEquals(prop, StringUtils.splitArrayElementsIntoProperties(array2, "=", ""));

        final String[] array3 = {"    1=foo   ", "   2=bar    "};
        final Properties prop2 = new Properties();
        prop2.setProperty("1", "foo");
        prop2.setProperty("2", "bar");
    ...
    public void testToStringArray() {
        ...
        Assert.assertNull(StringUtils.toS   tringArray(collection));
